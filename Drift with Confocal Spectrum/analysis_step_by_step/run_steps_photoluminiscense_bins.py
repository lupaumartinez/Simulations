...
base_folder = 'C:/Users/Alumno/Dropbox/Simule Drift with Confocal Spectrum/'
NP_folder = 'number_pixel_10_pixel_time_0.8'
#NP_folder = 'AuNPz_NPC_60magicas/set_de_mediciones_automaticas/20190829_repetitividad'
#parent_folder = 'C:/Users/Alumno/Dropbox/Simule Drift with Confocal/Simulation_spectrum_on_confocal'
...
totalbins_list = [6, 7, 8, 9, 10] #number of bins
...
if step2ok and not single_NP_flag:
    #step4.plots_processed_data_bins(parent_folder)  #para simulaciones
    step4.real_plots_processed_data_bins(parent_folder, NP_int)  #data real, tmb se fija el caso de a una NP_int
else:
